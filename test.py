...
def get_it(url):
    try:
        ...
        "tch": 1,
        "hl": "en",
        "q": urllib.parse.quote_plus("The Lal Street LEVEL 2 GACHIBOWLI, SLN Terminus, THE LAL STREET, Gachibowli - Miyapur Rd, Gachibowli, Hyderabad, Telangana 500032"),
