...
total_names=[]
def job():
    data={"cityId":"35f85795-c119-4e37-9a24-ec8018810616"}
    ...
    for n in range(int(len(updateRecords)/insertnumber)+1):
        ...
        response = re.post("http://scouterlive.us-east-1.elasticbeanstalk.com/api/v1/Place/UpdateCurrentPopularity",json=updateRecords[n * insertnumber :start], headers=headers, timeout=20 *60)
        try:
            print(response.json())
        except:
            pass
